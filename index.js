    ...
    !(function (t, e) {
        ...
        var t = "millisecond",
            ...
            d = {
                ...
                p: function (h) {
                    return (
                        { M: u, y: o, w: s, d: i, D: "date", h: r, m: n, s: e, ms: t, Q: a }[h] ||
                        String(h || "")
                            .toLowerCase()
                            .replace(/s$/, "")
                    );
                    ...
                    _vm.button
                        ? _c("div", { staticClass: "k-vercel-button", class: { loading: _vm.isLoading, success: _vm.isSuccess, error: _vm.isError }, on: { click: _vm.deploySite } }, [
                              ...
                              _vm.latest && !_vm.isLoading && !_vm.isSuccess && !_vm.isError
                                  ? _c(
                                        "div",
                                        { staticClass: "k-vercel-changes", class: { new: _vm.newContent } },
                                        [_vm.newContent ? _c("span", [_vm._v(_vm._s(_vm.siteModified.count) + " \u2191")]) : _c("k-icon", { attrs: { type: "check" } })],
                                        1
                                    )
                                  : _vm._e(),
                          ])
